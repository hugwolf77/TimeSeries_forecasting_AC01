...
class Dataset_base(Dataset):
    def __init__(self, root_path, flag='train', size=None, features='MS', data_path='base.csv',
    ...
    def __read_data__(self):
        ...
        df_raw = pd.read_csv(os.path.join(
            self.root_path, self.data_path), encoding='cp949')

        '''
        df_raw.columns: ['date', ...(other features), target feature]
        '''
        # print(f"Set-Before ========> columns : {df_raw.columns}")
        cols = list(df_raw.columns)
        cols.remove('date')
        cols.remove(self.target)
        # target value position define
        df_raw = df_raw[['date'] + cols + [self.target]]
        # print(f"Set-After ========> columns : {df_raw.columns}")
        ...
        # print(f"df_data.cols : {df_data.columns}")
...
class Dataset_Pred(Dataset):
    def __init__(self, root_path, flag='pred', size=None, features='MS', data_path='pred.csv',
    ...
    def __read_data__(self):
        ...
        '''
        df_raw.columns: ['일시', ...(other features), target feature]
        '''
        cols = list(df_raw.columns)
        cols.remove('date')
        cols.remove('target')
